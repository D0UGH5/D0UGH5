...
Sou um desenvolvedor Back-end em início de carreira, atualmente cursando **Análise e Desenvolvimento de Sistemas**. Estou em transição de carreira, trazendo uma base sólida de quase 3 anos de experiência em suporte técnico e atendimento ao cliente. Hoje, atuo como Estagiário de Inovação Tecnológica, aplicando meus conhecimentos para desenvolver soluções que otimizam processos corporativos.

Estou buscando ativamente por uma oportunidade como desenvolvedor para aplicar minha paixão por programação e contribuir para projetos inovadores.
